...
def _(
    ...
    def get_dashboard_full_ui():
        return mo.vstack(
            [
                # Top row: sidebar + KPIs + histogram
                mo.hstack([
                    get_sidebar_ui(),   
                    mo.vstack([
                        get_predicted_price_ui(),
                ...
                # Middle row: feature contribution
                feature_contribution(),
    ...
    return (get_dashboard_full_ui,)


@app.cell
def _(get_dashboard_full_ui):
    get_dashboard_full_ui()
    return
